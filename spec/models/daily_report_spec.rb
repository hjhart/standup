...
describe DailyReport do
  it "should have a valid factory" do
    FactoryGirl.create(:daily_report).should be_valid
  end
  ...
  describe "#create_individual_tasks" do
    it "should break apart the lines and create tasks out of them" do
      ...
      FactoryGirl.create(:daily_report, :plain_part => plain_text)
    end
  ...
  describe "#yesterdays" do
    xit "is a named scope that should return yesterdays report" do
      new_report = FactoryGirl.create(:daily_report, :created_at => Date.today)
      old_one = FactoryGirl.create(:daily_report, :created_at => 15.days.ago)
